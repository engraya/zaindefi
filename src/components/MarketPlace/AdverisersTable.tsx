              ...
              <td className="p-2 border-b border-slate-600">
                {selectedAction === 'buy' ? (
                  <button 
                    ...
                    className="self-stretch px-4 py-2 bg-emerald-500 rounded inline-flex justify-center items-center overflow-hidden"
                  >
                  ...
                  <button 
                    ...
                    className="self-stretch px-4 py-2 bg-rose-700 rounded inline-flex justify-center items-center overflow-hidden"
                  >
                    <div className="h-4 flex justify-center items-center gap-2">
