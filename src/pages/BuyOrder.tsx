...
function BuyOrder() {
  ...
  }, [paymentAmount, receiveAmount, selectedPayment]);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 md:p-6" style={{ backgroundColor: '#171825BF' }}>
      <div data-property-1="buy-card" className="bg-gray-900 rounded-3xl flex flex-col md:flex-row justify-start items-start gap-6 w-full max-w-[768px] md:max-w-[800px]">
        {/* Left Card */}
        <div className="w-full md:w-96 p-4 md:p-6 flex flex-col justify-start items-start gap-4">
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
                ...
                <div className="self-stretch px-2.5 py-2 bg-slate-800 rounded-lg flex flex-col justify-start items-start gap-2.5">
                    <div className="inline-flex justify-start items-center gap-1">
                        <PayToolTipSvg/>
                        <div className="text-center justify-center text-gray-200 text-[10px] font-normal leading-[8.50px]">Pay With Your Own Account</div>
                    </div>
                </div>
            </div>
            <div className="self-stretch flex-1 inline-flex justify-start items-start overflow-hidden">
                <div className="flex-1 self-stretch inline-flex flex-col justify-start items-start gap-4">
                    ...
                    <div className="self-stretch justify-center text-zinc-400 text-sm font-normal leading-none">ATTENTION! ATTENTION!! Make your payment in full</div>
        ...
        {/* Right Card */}
        <div className="flex-1 h-[563px] p-4 md:p-6 bg-slate-800 md:rounded-tr-3xl md:rounded-br-3xl rounded-b-3xl md:rounded-bl-none flex flex-col justify-between items-center">
            <div className="self-stretch flex-1 flex flex-col justify-start items-start gap-5">
                ...
                <div className="self-stretch flex flex-col gap-5">
                    <div data-property-1="Default" data-show-all="false" data-show-icon="false" className="w-full flex flex-col justify-start items-start gap-1">
                        <div className="self-stretch justify-center text-slate-500 text-sm font-medium leading-tight">I will pay</div>
